 ...
 * The generic CommentModel object should be materialized to CommentInterResort object
 */
@Component("commentInterResortDao")
public class CommentInterResortDaoImpl implements CommentDao{
	...
	public boolean delete(int id) {
		CommentInterResort comment = new CommentInterResort();
		comment.setId(id);
		ht.delete(comment);
		return true;
	}
	...
	public List<CommentModel> getAll() {
		return (List<CommentModel>) getAllInterResortComments();
	}
	...
	public Collection<CommentModel> getAllInterResortComments(){
		return this.ht.find("from CommentInterResort");
	}
	...
	public Collection<CommentModel> getManyByDateDiff(Date from, Date to){
		return this.ht.find("from CommentInterResort c where c.commentDate > ? and c.commentDate < ?", from, to);
	}

	@Override
	public CommentModel get(int id) {
		return ht.get(CommentInterResort.class, id);
	}
