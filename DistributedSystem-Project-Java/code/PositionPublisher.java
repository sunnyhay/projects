...
public class PositionPublisher {
    ...
    public void publisherMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            final long sendPeriodMillis = 2000;//(long)(instance.timeBetweenStops * 1000); 
            ...
            for (int count = 0;
                ...
                //System.out.println("Position stopnumber: " + instance.stopNumber);
                //System.out.println("Position timeInterval: " + instance.timeBetweenStops);
                /* Write data */
		try {
