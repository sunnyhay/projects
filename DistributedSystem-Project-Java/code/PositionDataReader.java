...
/**
 * A reader for the Position user type.
 */
public class PositionDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(PositionSeq received_data, SampleInfoSeq info_seq,
             int max_samples,
    ...
    public void take(PositionSeq received_data, SampleInfoSeq info_seq,
             int max_samples,
             int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(PositionSeq received_data, 
    ...
    public void take_w_condition(PositionSeq received_data, 
                 SampleInfoSeq info_seq,
                 int max_samples,
                 ReadCondition condition) {
    ...
    public void read_next_sample(Position received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }


    public void take_next_sample(Position received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }


    public void read_instance(PositionSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(PositionSeq received_data, SampleInfoSeq info_seq,
            int max_samples, InstanceHandle_t a_handle, int sample_states,
            int view_states, int instance_states) {
    ...
    public void read_next_instance(PositionSeq received_data,
    ...
    public void take_next_instance(PositionSeq received_data,
            SampleInfoSeq info_seq, int max_samples,
            InstanceHandle_t a_handle, int sample_states, int view_states,
            int instance_states) {
    ...
    public void read_next_instance_w_condition(PositionSeq received_data,
            SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance_w_condition(PositionSeq received_data,
            SampleInfoSeq info_seq, int max_samples,
            InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(PositionSeq received_data, SampleInfoSeq info_seq) {
    ...
    /*package*/ PositionDataReader(long native_reader, DataReaderListener listener,
