...
public class PositionSubscriberSecond {
    ...
    public void subscriberMain(int domainId, int sampleCount) {
	    ...
	    ContentFilteredTopic cft = participant.create_contentfilteredtopic(topic.get_name() + " (filtered)", topic, filtered, null); 
	    if(cft == null) {
    ...
    private static class PositionListener extends DataReaderAdapter {
        ...
        public void on_data_available(DataReader reader) {
			...
			if(counter > 1) {
			    ...
			    System.out.println("Arriving at stop #" + instance.stopNumber + " at " + instance.timestamp + ", " + instance.trafficConditions + ", " + accidentOrNot + counter + " stops left");
			    ...
			    System.out.println("Arriving at destination by " + instance.vehicle + " at " + instance.timestamp);
			    flag = true;
			}
                        //System.out.println(
