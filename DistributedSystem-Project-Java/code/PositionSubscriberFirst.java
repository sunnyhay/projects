...
public class PositionSubscriberFirst {
    ...
    public void subscriberMain(int domainId, int sampleCount) {
	    ...
	    String filterExpression = "route MATCH 'Express" + routeNumber + "' and stopNumber = " + sourceStop; 
	    ContentFilteredTopic cft = participant.create_contentfilteredtopic(topic.get_name() + " (filtered)", topic, filterExpression, null); 
    ...
    private static class PositionListener extends DataReaderAdapter {
        ...
        public void on_data_available(DataReader reader) {
            ...
            try {
			    ...
			    //calculate the number of remaining stops next
			    if(destinationStop < sourceStop) 
			        remainingStops = destinationStop + numStops - sourceStop;
			    else
			        remainingStops = destinationStop - sourceStop;
			    System.out.println("Getting on " + vehicle + " at stop #" + stopNumber + " at " + timestamp + ", " + trafficConditions + ", " + accidentOrNot + remainingStops + " stops left");
			    getOn = true;
			    //System.out.println(instance.vehicle + " of route " + instance.route + " stops in " + instance.stopNumber + " at " + instance.timestamp + " with traffic " + instance.trafficConditions + " and stopinterval " + instance.timeBetweenStops);			
			    flag = true;
                            //this.interrupt();
			    //System.out.println(
